...
ALLOWED_HOSTS = ['helpdream.ru', 'www.helpdream.ru']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'u1581954_u1581954',
        'USER': 'u1581954_sergey',
        'PASSWORD': '21nika12345',
        'HOST': 'localhost',
    }
}
...
# Перед collectstatic это раскоментировать а STATIC DIR закоментировать ВАЖНО ВАЖНО ВАЖНО!
